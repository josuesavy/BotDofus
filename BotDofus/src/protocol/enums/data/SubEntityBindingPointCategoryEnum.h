#ifndef SUBENTITYBINDINGPOINTCATEGORYENUM_H
#define SUBENTITYBINDINGPOINTCATEGORYENUM_H

enum class SubEntityBindingPointCategoryEnum
{
...
#endif // SUBENTITYBINDINGPOINTCATEGORYENUM_H