#ifndef EXCHANGEHANDLEMOUNTSTABLETYPEENUM_H
#define EXCHANGEHANDLEMOUNTSTABLETYPEENUM_H

enum class ExchangeHandleMountStableTypeEnum
{
...
#endif // EXCHANGEHANDLEMOUNTSTABLETYPEENUM_H