...
void MapComplementaryInformationsDataMessage::deserializeAs_MapComplementaryInformationsDataMessage(Reader *input)
{
  ...
  uint _actorsLen = input->readUShort();
  ...
  uint _interactiveElementsLen = input->readUShort();
  ...
  uint _statedElementsLen = input->readUShort();
  ...
  uint _obstaclesLen = input->readUShort();
