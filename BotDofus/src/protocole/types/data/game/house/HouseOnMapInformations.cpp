...
void HouseOnMapInformations::serializeAs_HouseOnMapInformations(Writer *output)
{
  ...
  {
    qSharedPointerCast<HouseInstanceInformations>(this->houseInstances[_i2])->serializeAs_HouseInstanceInformations(output);
  }
}
...
{
  uint _val1 = 0;
  QSharedPointer<HouseInstanceInformations> _item2 ;
  HouseInformations::deserialize(input);
  uint _doorsOnMapLen = input->readUShort();
  ...
  uint _houseInstancesLen = input->readUShort();
  for(uint _i2 = 0; _i2 < _houseInstancesLen; _i2++)
  {
    _item2 = QSharedPointer<HouseInstanceInformations>(new HouseInstanceInformations() );
...
{
  QSharedPointer<HouseInstanceInformations> _item = QSharedPointer<HouseInstanceInformations>(new HouseInstanceInformations() );
