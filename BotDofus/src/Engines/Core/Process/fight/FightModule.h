...
/*!
 * \class The FightModule class handle the condition in the start fight, the cast spells, the distance of target, the possibilities to reach a target with a spell.
 * \brief Module to handle the fights
...
public:
    FightModule(QMap<SocketIO*, BotData> *connectionsData, MapModule *mapModule, GroupModule *groupModule, ArenaModule *arenaModule);
