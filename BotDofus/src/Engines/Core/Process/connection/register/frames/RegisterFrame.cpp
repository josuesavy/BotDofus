...
RegisterFrame::RegisterFrame(QMap<SocketIO *, BotData> *connectionsData):
    AbstractFrame(ModuleType::CONNECTION, connectionsData)
{

}

void RegisterFrame::reset(SocketIO *sender)
{
    m_botData[sender].connectionData.connectionState = ConnectionState::DISCONNECTED;
}

bool RegisterFrame::processMessage(const MessageInfos &data, SocketIO *sender)
{
