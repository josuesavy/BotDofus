#include "ServerSelectionFrame.h"

ServerSelectionFrame::ServerSelectionFrame(QMap<SocketIO *, BotData> *connectionsData):
    AbstractFrame(ModuleType::CONNECTION, connectionsData)
{

}

void ServerSelectionFrame::reset(SocketIO *sender)
{

}

bool ServerSelectionFrame::processMessage(const MessageInfos &data, SocketIO *sender)
{
    ...
    case MessageEnum::SERVERSLISTMESSAGE:
    {
        ...
        // TODO: ServerStatusUpdateMessage
    ...
    case MessageEnum::SELECTEDSERVERDATAMESSAGE:
    {
        ...
        // TODO: AcquaintanceSearchErrorMessage, AcquaintanceServerListMessage
    ...
    case MessageEnum::SELECTEDSERVERREFUSEDMESSAGE:
    {
        ...
        // TODO: MigratedServerListMessage, ServerConnectionFailedMessage
    }
