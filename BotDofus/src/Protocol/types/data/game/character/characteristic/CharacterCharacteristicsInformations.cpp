...
void CharacterCharacteristicsInformations::serializeAs_CharacterCharacteristicsInformations(Writer *output)
{
  ...
  {
    qSharedPointerCast<CharacterSpellModification>(this->spellModifications[_i9])->serializeAs_CharacterSpellModification(output);
  }
...
void CharacterCharacteristicsInformations::deserializeAs_CharacterCharacteristicsInformations(Reader *input)
{
  ...
  QSharedPointer<CharacterSpellModification> _item9 ;
  ...
  {
    _item9 = QSharedPointer<CharacterSpellModification>(new CharacterSpellModification() );
...
{
  QSharedPointer<CharacterSpellModification> _item = QSharedPointer<CharacterSpellModification>(new CharacterSpellModification() );
  _item->deserialize(input);
