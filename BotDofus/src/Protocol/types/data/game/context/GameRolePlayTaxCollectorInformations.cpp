...
void GameRolePlayTaxCollectorInformations::deserializeAsyncAs_GameRolePlayTaxCollectorInformations(FuncTree tree)
{
  ...
  tree.addChild(std::bind(&GameRolePlayTaxCollectorInformations::_guildLevelFunc, this, std::placeholders::_1));
...
void GameRolePlayTaxCollectorInformations::_guildLevelFunc(Reader *input)
{
