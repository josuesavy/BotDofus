...
{
  if(this->alignmentWarEffortDailyLimit < 0 || this->alignmentWarEffortDailyLimit > 9.007199254740992E15)
  {
  ...
  if(this->alignmentWarEffortDailyDonation < 0 || this->alignmentWarEffortDailyDonation > 9.007199254740992E15)
  {
  ...
  if(this->alignmentWarEffortPersonalDonation < 0 || this->alignmentWarEffortPersonalDonation > 9.007199254740992E15)
  {
