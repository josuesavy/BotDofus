#ifndef SOCIALGROUPCREATIONRESULTENUM_H
#define SOCIALGROUPCREATIONRESULTENUM_H

enum class SocialGroupCreationResultEnum
{
...
#endif // SOCIALGROUPCREATIONRESULTENUM_H