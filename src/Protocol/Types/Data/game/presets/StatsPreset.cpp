...
void StatsPreset::deserializeAs_StatsPreset(Reader *input)
{
  ...
  uint _statsLen = input->readUShort();
  for(uint _i1 = 0; _i1 < _statsLen; _i1++)
  {
    _item1 = SimpleCharacterCharacteristicForPreset();
...
{
  SimpleCharacterCharacteristicForPreset _item = SimpleCharacterCharacteristicForPreset();
