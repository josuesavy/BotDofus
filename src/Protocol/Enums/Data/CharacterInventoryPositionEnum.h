#ifndef CHARACTERINVENTORYPOSITIONENUM_H
#define CHARACTERINVENTORYPOSITIONENUM_H

enum class CharacterInventoryPositionEnum
{
...
#endif // CHARACTERINVENTORYPOSITIONENUM_H