...
QSharedPointer<AbstractGameData> GameDataConverter::getClass(const QString &name)
{
  ...
  else if(name == "AllianceRank")
      return QSharedPointer<AbstractGameData>(new AllianceRankData());
  
  else if(name == "AllianceRankNameSuggestion")
      return QSharedPointer<AbstractGameData>(new AllianceRankNameSuggestionData());
  
  else if(name == "AllianceRight")
      return QSharedPointer<AbstractGameData>(new AllianceRightData());
  
  else if(name == "AllianceRightGroup")
      return QSharedPointer<AbstractGameData>(new AllianceRightGroupData());
  
  else if(name == "AllianceTag")
      return QSharedPointer<AbstractGameData>(new AllianceTagData());
  
  else if(name == "AllianceTagsType")
      return QSharedPointer<AbstractGameData>(new AllianceTagsTypeData());
  
  else if(name == "KothRole")
      return QSharedPointer<AbstractGameData>(new KothRoleData());
  ...
  else if(name == "AchievementPioneerItemCriterion")
      return QSharedPointer<AbstractGameData>(new AchievementPioneerItemCriterionData());
  ...
  else if(name == "AllianceMasterItemCriterion")
      return QSharedPointer<AbstractGameData>(new AllianceMasterItemCriterionData());
  ...
  else if(name == "Arena1V1LeagueCriterion")
      return QSharedPointer<AbstractGameData>(new Arena1V1LeagueCriterionData());
  
  else if(name == "Arena2V2LeagueCriterion")
      return QSharedPointer<AbstractGameData>(new Arena2V2LeagueCriterionData());
  
  else if(name == "Arena3V3LeagueCriterion")
      return QSharedPointer<AbstractGameData>(new Arena3V3LeagueCriterionData());
  
  else if(name == "ArenaMax1V1LeagueCriterion")
      return QSharedPointer<AbstractGameData>(new ArenaMax1V1LeagueCriterionData());
  
  else if(name == "ArenaMax2V2LeagueCriterion")
      return QSharedPointer<AbstractGameData>(new ArenaMax2V2LeagueCriterionData());
  
  else if(name == "ArenaMax3V3LeagueCriterion")
      return QSharedPointer<AbstractGameData>(new ArenaMax3V3LeagueCriterionData());
  ...
  else if(name == "OptionalFeatureEnabledCriterion")
      return QSharedPointer<AbstractGameData>(new OptionalFeatureEnabledCriterionData());
  ...
  else if(name == "PrismOnMapStateItemCriterion")
      return QSharedPointer<AbstractGameData>(new PrismOnMapStateItemCriterionData());
  ...
  else if(name == "SeasonCriterion")
      return QSharedPointer<AbstractGameData>(new SeasonCriterionData());
  ...
  else if(name == "SubareaLevelItemCriterion")
      return QSharedPointer<AbstractGameData>(new SubareaLevelItemCriterionData());
  ...
  else if(name == "ItemSuperType")
      return QSharedPointer<AbstractGameData>(new ItemSuperTypeData());
  ...
  else if(name == "ExpeditionSeason")
      return QSharedPointer<AbstractGameData>(new ExpeditionSeasonData());
  
  else if(name == "ServerSeason")
      return QSharedPointer<AbstractGameData>(new ServerSeasonData());
  ...
  else if(name == "SocialRight")
      return QSharedPointer<AbstractGameData>(new SocialRightData());
  
  else if(name == "SocialRightGroup")
      return QSharedPointer<AbstractGameData>(new SocialRightGroupData());
  
  else if(name == "SocialTag")
      return QSharedPointer<AbstractGameData>(new SocialTagData());
  
  else if(name == "SocialTagsType")
      return QSharedPointer<AbstractGameData>(new SocialTagsTypeData());
  ...
  else if(name == "BoundScriptUsageData")
      return QSharedPointer<AbstractGameData>(new BoundScriptUsageDataData());
  
  else if(name == "EffectZone")
      return QSharedPointer<AbstractGameData>(new EffectZoneData());
  ...
  else if(name == "SpellScript")
      return QSharedPointer<AbstractGameData>(new SpellScriptData());
  ...
  {
    qWarning()<<"(GameDataConverter) - Ne connait pas la classe :"<<name;
    return QSharedPointer<AbstractGameData>(NULL);
  }
}
...
GameDataTypeEnum GameDataConverter::getEnum(const QString &name)
{
  ...
  else if(name == "AllianceRanks")
      return GameDataTypeEnum::ALLIANCERANKS;
  
  else if(name == "AllianceRankNameSuggestions")
      return GameDataTypeEnum::ALLIANCERANKNAMESUGGESTIONS;
  
  else if(name == "AllianceRights")
      return GameDataTypeEnum::ALLIANCERIGHTS;
  
  else if(name == "AllianceRightGroups")
      return GameDataTypeEnum::ALLIANCERIGHTGROUPS;
  
  else if(name == "AllianceTags")
      return GameDataTypeEnum::ALLIANCETAGS;
  
  else if(name == "AllianceTagsTypes")
      return GameDataTypeEnum::ALLIANCETAGSTYPES;
  
  else if(name == "KothRoles")
      return GameDataTypeEnum::KOTHROLES;
  ...
  else if(name == "ItemSuperTypes")
      return GameDataTypeEnum::ITEMSUPERTYPES;
  ...
  else if(name == "ExpeditionSeasons")
      return GameDataTypeEnum::EXPEDITIONSEASONS;
  
  else if(name == "ServerSeasons")
      return GameDataTypeEnum::SERVERSEASONS;
  ...
  else if(name == "SpellScripts")
      return GameDataTypeEnum::SPELLSCRIPTS;
  ...
  {
    qWarning()<<"(GameDataConverter) Ne connait pas l'enum :"<<name;
    return GameDataTypeEnum::UNKNOWN;
  }
}
