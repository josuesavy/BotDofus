...
void TaxCollectorDialogQuestionExtendedMessage::deserializeAsyncAs_TaxCollectorDialogQuestionExtendedMessage(FuncTree tree)
{
  ...
  this->_alliancetree = tree.addChild(std::bind(&TaxCollectorDialogQuestionExtendedMessage::_alliancetreeFunc, this, std::placeholders::_1));
...
void TaxCollectorDialogQuestionExtendedMessage::_alliancetreeFunc(Reader *input)
{
  this->alliance = QSharedPointer<BasicNamedAllianceInformations>(new BasicNamedAllianceInformations() );
