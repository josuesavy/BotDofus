...
void AllianceListApplicationAnswerMessage::serializeAs_AllianceListApplicationAnswerMessage(Writer *output)
{
  ...
  {
    qSharedPointerCast<SocialApplicationInformation>(this->applies[_i1])->serializeAs_SocialApplicationInformation(output);
  }
}
...
{
  QSharedPointer<SocialApplicationInformation> _item1 ;
  ...
  {
    _item1 = QSharedPointer<SocialApplicationInformation>(new SocialApplicationInformation() );
...
{
  QSharedPointer<SocialApplicationInformation> _item = QSharedPointer<SocialApplicationInformation>(new SocialApplicationInformation() );
