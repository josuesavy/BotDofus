#ifndef TEXTINFORMATIONTYPEENUM_H
#define TEXTINFORMATIONTYPEENUM_H

enum class TextInformationTypeEnum
{
    ...
    TEXT_INFORMATION_EVENT = 9
};

#endif // TEXTINFORMATIONTYPEENUM_H