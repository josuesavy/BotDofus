...
void GroupMonsterStaticInformationsWithAlternatives::deserializeAs_GroupMonsterStaticInformationsWithAlternatives(Reader *input)
{
  ...
  {
    _item1 = new com.ankamagames.dofus.network.types.game.context.roleplay.AlternativeMonstersInGroupLightInformations();
...
{
   _item = new com.ankamagames.dofus.network.types.game.context.roleplay.AlternativeMonstersInGroupLightInformations();
