...
void ArenaRankInfos::deserializeAs_ArenaRankInfos(Reader *input)
{
  ...
  {
    this->ranking = new com.ankamagames.dofus.network.types.game.context.roleplay.fight.arena.ArenaRanking();
  ...
  {
    this->leagueRanking = new com.ankamagames.dofus.network.types.game.context.roleplay.fight.arena.ArenaLeagueRanking();
