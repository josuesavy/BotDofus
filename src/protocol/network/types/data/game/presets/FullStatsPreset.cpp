...
void FullStatsPreset::deserializeAs_FullStatsPreset(Reader *input)
{
  ...
  {
    _item1 = new com.ankamagames.dofus.network.types.game.presets.CharacterCharacteristicForPreset();
...
{
   _item = new com.ankamagames.dofus.network.types.game.presets.CharacterCharacteristicForPreset();
