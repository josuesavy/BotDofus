...
void GameActionMark::serializeAs_GameActionMark(Writer *output)
{
  ...
  {
    (this->cells[_i8] as com.ankamagames.dofus.network.types.game.actions.fight.GameActionMarkedCell).serializeAs_GameActionMarkedCell(output);
  }
...
{
  com.ankamagames.dofus.network.types.game.actions.fight.GameActionMarkedCell _item8 ;
  ...
  {
    _item8 = new com.ankamagames.dofus.network.types.game.actions.fight.GameActionMarkedCell();
...
{
   _item = new com.ankamagames.dofus.network.types.game.actions.fight.GameActionMarkedCell();
