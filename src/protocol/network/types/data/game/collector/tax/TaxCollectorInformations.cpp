...
void TaxCollectorInformations::serializeAs_TaxCollectorInformations(Writer *output)
{
  ...
  {
    output->writeShort((short)(this->complements[_i11]).getTypeId());
...
void TaxCollectorInformations::deserializeAs_TaxCollectorInformations(Reader *input)
{
  ...
  this->additionalInfos = new com.ankamagames.dofus.network.types.game.collector.tax.AdditionalTaxCollectorInformation();
  ...
  for(uint _i11 = 0; _i11 < _complementsLen; _i11++)
  {
    ...
    _item11 = qSharedPointerCast<>(ClassManagerSingleton::get()->getClass(_id11));
  ...
  {
    _item14 = new com.ankamagames.dofus.network.types.game.collector.tax.TaxCollectorOrderedSpell();
