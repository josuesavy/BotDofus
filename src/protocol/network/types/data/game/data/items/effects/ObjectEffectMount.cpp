...
void ObjectEffectMount::deserializeAs_ObjectEffectMount(Reader *input)
{
  ...
  {
    _item13 = new com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectInteger();
...
{
   _item = new com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectInteger();
