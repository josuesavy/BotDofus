...
void StatisticsForm::updateInterface(bool directCall)
{
    ...
    if(infos.statisticsData.countTotalExperience != 0 || infos.statisticsData.countTotalExperienceJobs.size() != 0 || infos.statisticsData.countTotalExperienceMount != 0 || infos.statisticsData.countTotalExperienceGuild != 0 || infos.statisticsData.countTotalExperienceIncarnation != 0 || infos.statisticsData.countTotalGetNewLevel != 0 || infos.statisticsData.countTotalGetNewLevelJobs.size() != 0 || infos.statisticsData.countTotalPointVitality != 0 || infos.statisticsData.countTotalPointWisdom != 0 || infos.statisticsData.countTotalPointStrength != 0 || infos.statisticsData.countTotalPointIntelligence != 0 || infos.statisticsData.countTotalPointChance != 0 || infos.statisticsData.countTotalPointAgility != 0)
    {
        ...
        item->setText(0, "Caracteristiques");
        ...
        if(infos.statisticsData.countTotalExperience != 0 || infos.statisticsData.countTotalExperienceJobs.size() != 0)
        {
            ...
            subItem->setText(0, QString("Experiences totale : %1").arg(infos.statisticsData.countTotalExperience + totalExperiencesJobs));
            item->addChild(subItem);

            if(infos.statisticsData.countTotalExperience != 0)
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Personnage : %1").arg(infos.statisticsData.countTotalExperience));
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Monture: %1").arg(infos.statisticsData.countTotalExperienceMount));
            item->addChild(subItem);
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Guilde: %1").arg(infos.statisticsData.countTotalExperienceGuild));
            item->addChild(subItem);
        }
        ...
        if(infos.statisticsData.countTotalGetNewLevel != 0 || infos.statisticsData.countTotalGetNewLevelJobs.size() != 0)
        {
            ...
            // Add and display total xp jobs+bot
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Nombre de niveau pri au totale : %1").arg(infos.statisticsData.countTotalGetNewLevel + totalLevelsJobs));
            item->addChild(subItem);

            if(infos.statisticsData.countTotalGetNewLevel != 0)
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Personnage : %1").arg(infos.statisticsData.countTotalGetNewLevel));
                subItem->addChild(subSubItem);
            }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Nombres totale de points de caracteristique: %1").arg(infos.statisticsData.countTotalPointVitality + infos.statisticsData.countTotalPointWisdom + infos.statisticsData.countTotalPointStrength + infos.statisticsData.countTotalPointIntelligence + infos.statisticsData.countTotalPointChance + infos.statisticsData.countTotalPointAgility));
            item->addChild(subItem);

            if(infos.statisticsData.countTotalPointVitality != 0)
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Vitalité : %1").arg(infos.statisticsData.countTotalPointVitality));
                subItem->addChild(subSubItem);
            }
            ...
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Sagesse : %1").arg(infos.statisticsData.countTotalPointWisdom));
                subItem->addChild(subSubItem);
            }
            ...
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Force : %1").arg(infos.statisticsData.countTotalPointStrength));
                subItem->addChild(subSubItem);
            }
            ...
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Agilité : %1").arg(infos.statisticsData.countTotalPointAgility));
                subItem->addChild(subSubItem);
            }
        }
    ...
    {
        QTreeWidgetItem *item = new QTreeWidgetItem(ui->treeWidget);
        item->setText(0, "Inventaire");
        ui->treeWidget->addTopLevelItem(item);

        if(infos.statisticsData.countTotalResourcesFight != 0 || infos.statisticsData.countTotalResourcesGather != 0)
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Ressources totale : %1").arg(infos.statisticsData.countTotalResourcesFight + infos.statisticsData.countTotalResourcesGather));
            item->addChild(subItem);

            if(infos.statisticsData.countTotalResourcesFight != 0)
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Combat : %1").arg(infos.statisticsData.countTotalResourcesFight));
                subItem->addChild(subSubItem);
            }
            ...
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Recolte : %1").arg(infos.statisticsData.countTotalResourcesGather));
                subItem->addChild(subSubItem);
            }
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Objets totale : %1").arg(infos.statisticsData.countTotalObjectWonFight + infos.statisticsData.countTotalObjectWonGather));
            item->addChild(subItem);

            if(infos.statisticsData.countTotalObjectWonFight != 0)
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Combat : %1").arg(infos.statisticsData.countTotalObjectWonFight));
                subItem->addChild(subSubItem);
            }
            ...
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Recolte : %1").arg(infos.statisticsData.countTotalObjectWonGather));
                subItem->addChild(subSubItem);
            }
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Kamas totale : %1").arg(infos.statisticsData.countTotalKamas));
            item->addChild(subItem);
        }
    }
    ...
    if(infos.statisticsData.countFightSetWon != 0 || infos.statisticsData.countFightSetLost != 0 || infos.statisticsData.countFightGetWon != 0 || infos.statisticsData.countFightGetLost != 0 || infos.statisticsData.speedFight != 0)
    {
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Combats totale : %1").arg(infos.statisticsData.countFightSetWon + infos.statisticsData.countFightSetLost + infos.statisticsData.countFightGetWon + infos.statisticsData.countFightGetLost));
            item->addChild(subItem);

            if(infos.statisticsData.countFightSetWon != 0 || infos.statisticsData.countFightSetLost != 0)
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Lancés : %1").arg(infos.statisticsData.countFightSetWon + infos.statisticsData.countFightSetLost));
                subItem->addChild(subSubItem);

                if(infos.statisticsData.countFightSetWon != 0)
                {
                    QTreeWidgetItem *subSubSubItem = new QTreeWidgetItem(subSubItem);
                    subSubSubItem->setText(0, QString("Gagnés : %1").arg(infos.statisticsData.countFightSetWon));
                    subSubItem->addChild(subSubSubItem);
                }
                ...
                {
                    QTreeWidgetItem *subSubSubItem = new QTreeWidgetItem(subSubItem);
                    subSubSubItem->setText(0, QString("Perdus : %1").arg(infos.statisticsData.countFightSetLost));
                    subSubItem->addChild(subSubSubItem);
                }
            }
            ...
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Recu : %1").arg(infos.statisticsData.countFightGetWon + infos.statisticsData.countFightGetLost));
                subItem->addChild(subSubItem);

                if(infos.statisticsData.countFightGetWon != 0)
                {
                    QTreeWidgetItem *subSubSubItem = new QTreeWidgetItem(subSubItem);
                    subSubSubItem->setText(0, QString("Gagnés : %1").arg(infos.statisticsData.countFightGetWon));
                    subSubItem->addChild(subSubSubItem);
                }
                ...
                {
                    QTreeWidgetItem *subSubSubItem = new QTreeWidgetItem(subSubItem);
                    subSubSubItem->setText(0, QString("Perdus : %1").arg(infos.statisticsData.countFightGetLost));
                    subSubItem->addChild(subSubSubItem);
                }
            }
            ...
            {
                QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
                subItem->setText(0, QString("Vitesse moyenne : %1").arg(infos.statisticsData.speedFight / (infos.statisticsData.countFightSetWon+infos.statisticsData.countFightSetLost+infos.statisticsData.countFightGetWon+infos.statisticsData.countFightGetLost)));
                item->addChild(subItem);
            }
        }
    }
    ...
    {
        QTreeWidgetItem *item = new QTreeWidgetItem(ui->treeWidget);
        item->setText(0, "Recolte");
        ui->treeWidget->addTopLevelItem(item);

        QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
        subItem->setText(0, QString("Total recolte : %1").arg(infos.statisticsData.countTotalGatherWon + infos.statisticsData.countTotalGatherLost));
        item->addChild(subItem);

        if(infos.statisticsData.countTotalGatherWon != 0)
        {
            QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
            subSubItem->setText(0, QString("Gagné : %1").arg(infos.statisticsData.countTotalGatherWon));
            subItem->addChild(subSubItem);
        }
        ...
        {
            QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
            subSubItem->setText(0, QString("Perdu : %1").arg(infos.statisticsData.countTotalGatherLost));
            subItem->addChild(subSubItem);
        }
    }
    ...
    if(infos.statisticsData.countTotalMessageSent != 0 || infos.statisticsData.countTotalMessageFailed != 0)
    {
        ...
        {
            QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
            subSubItem->setText(0, QString("Reussis : %1").arg(infos.statisticsData.countTotalMessageSent));
            subItem->addChild(subSubItem);
        }
        ...
        {
            QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
            subSubItem->setText(0, QString("Echoues : %1").arg(infos.statisticsData.countTotalMessageFailed));
            subItem->addChild(subSubItem);
        }
    }
    ...
    {
        QTreeWidgetItem *item = new QTreeWidgetItem(ui->treeWidget);
        item->setText(0, "Divers");

        if(infos.statisticsData.countTotalReconnection != 0)
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Totale reconnexion : %1").arg(infos.statisticsData.countTotalReconnection));
            item->addChild(subItem);
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Total succès : %1").arg(infos.statisticsData.countTotalNotValidatedAchievement + infos.statisticsData.countTotalValidatedAchievement));
            item->addChild(subItem);

            if(infos.statisticsData.countTotalValidatedAchievement != 0)
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Accepte : %1").arg(infos.statisticsData.countTotalValidatedAchievement));
                subItem->addChild(subSubItem);
            }
            ...
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Non acceptes : %1").arg(infos.statisticsData.countTotalNotValidatedAchievement));
                subItem->addChild(subSubItem);
            }
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Total personnes rencontré : %1").arg(infos.statisticsData.countTotalMetPlayers.size()));
            item->addChild(subItem);
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Vitesse moyenne du reseau : %1 ms").arg(m_sender->getLatencyAverage())); // Faire le calcul
            item->addChild(subItem);
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Nombre de retour en banque : %1").arg(infos.statisticsData.countTotalBackToBank));
            item->addChild(subItem);
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Nombre de retour aux phénix : %1").arg(infos.statisticsData.countTotalBackToPhoenix));
            item->addChild(subItem);
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Nombre de relance du script : %1").arg(infos.statisticsData.countTotalRestartScript));
            item->addChild(subItem);
        }
        ...
        {
            QTreeWidgetItem *subItem = new QTreeWidgetItem(item);
            subItem->setText(0, QString("Total quetes : %1").arg(infos.statisticsData.countTotalValidatedQuest + infos.statisticsData.countTotalNewQuest));
            item->addChild(subItem);

            if(infos.statisticsData.countTotalValidatedQuest != 0)
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Nouvelle : %1").arg(infos.statisticsData.countTotalValidatedQuest));
                subItem->addChild(subSubItem);
            }
            ...
            {
                QTreeWidgetItem *subSubItem = new QTreeWidgetItem(subItem);
                subSubItem->setText(0, QString("Validé : %1").arg(infos.statisticsData.countTotalNewQuest));
                subItem->addChild(subSubItem);
            }
        }
